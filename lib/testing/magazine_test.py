...
class TestMagazine:
    ...
    def test_article_titles(self):
        ...
        Article(author_1, magazine_3, "How to be single and happy")
        assert magazine_1.article_titles() == [
            "How to wear a tutu with style",
            "Dating life in NYC",
        ]
        assert magazine_2.article_titles() == ["2023 Eccentric Design Trends"]
        assert magazine_3.article_titles() == ["How to be single and happy"]

    def test_contributing_authors(self):
        """returns list of names of all authors who have written more than 2 articles for the magazine"""
        author_1 = Author("Carry Bradshaw")
        author_2 = Author("Nathaniel Hawthorne")
        magazine_1 = Magazine("Vogue", "Fashion")
        magazine_2 = Magazine("AD", "Architecture")
        Article(author_1, magazine_1, "How to wear a tutu with style")
        Article(author_1, magazine_1, "Dating life in NYC")
        Article(author_1, magazine_1, "The wonders of cosmos")
        Article(author_2, magazine_1, "How to be single and happy")
        Article(author_1, magazine_2, "2023 Eccentric Design Trends")
        assert magazine_1.contributing_authors() == [author_1]
